...
function timeline_awesome_field_in_post() {
	...
	->add_tab(  esc_html__( 'Layout', 'timeline-awesome' ), array(
		...
		->add_options( array(
			'vertical-1'   => esc_html__( 'Vertical Hiji', 'timeline-awesome' ),
			'vertical-2'   => esc_html__( 'Vertical Dua', 'timeline-awesome' ),
			'vertical-3'   => esc_html__( 'Vertical Tilu', 'timeline-awesome' ),
			'vertical-7'   => esc_html__( 'Vertical Tujuh', 'timeline-awesome' ),
			'vertical-9'   => esc_html__( 'Vertical Salapan', 'timeline-awesome' ),
			'horizontal-6' => esc_html__( 'Horizontal Genep', 'timeline-awesome' ),
			'horizontal-9' => esc_html__( 'Horizontal Salapan', 'timeline-awesome' ),
		) ),
	))
	->add_tab(  esc_html__( 'Content', 'timeline-awesome' ), array(
	...
	->add_fields( array(
		Field::make( 'association', 'timeline_gutenberg_block', esc_html__( 'Timeline Awesome Post', 'timeline-awesome' ) )
		->set_min( 1 )
		->set_max( 1 )
		->set_types( array(
			array(
